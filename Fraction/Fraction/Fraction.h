...
public:
	...
	Fraction operator*(long long iNum);
	Fraction operator/(long long iNum);
	friend Fraction operator+(long long &iNum, const Fraction &fracFraction);
	friend Fraction operator-(long long &iNum, const Fraction &fracFraction);
	friend Fraction operator*(long long &iNum, const Fraction &fracFraction);
	friend Fraction operator/(long long &iNum, const Fraction &fracFraction);
	Fraction operator-();
	...
	bool operator==(Fraction fracFraction);
	bool operator!=(Fraction fracFraction);
	bool operator>(long long iNum);
	bool operator<(long long iNum);
	bool operator>=(long long iNum);
	bool operator<=(long long iNum);
	bool operator==(long long iNum);
	bool operator!=(long long iNum);
	bool operator>(double dNum);
	bool operator<(double dNum);
	bool operator>=(double dNum);
	bool operator<=(double dNum);
	bool operator==(double dNum);
	bool operator!=(double dNum);
	friend bool operator>(long long iNum, Fraction fracFraction);
	friend bool operator<(long long iNum, Fraction fracFraction);
	friend bool operator>=(long long iNum, Fraction fracFraction);
	friend bool operator<=(long long iNum, Fraction fracFraction);
	friend bool operator==(long long iNum, Fraction fracFraction);
	friend bool operator!=(long long iNum, Fraction fracFraction);
	friend bool operator>(double dNum, Fraction fracFraction);
	friend bool operator<(double dNum, Fraction fracFraction);
	friend bool operator>=(double dNum, Fraction fracFraction);
	friend bool operator<=(double dNum, Fraction fracFraction);
	friend bool operator==(double dNum, Fraction fracFraction);
...
Fraction operator+(long long iNum, const Fraction &fracFraction){
	return Fraction(iNum) + fracFraction;
}
Fraction operator-(long long iNum, const Fraction &fracFraction){
	return Fraction(iNum) - fracFraction;
}
...
Fraction operator/(long long iNum, const Fraction &fracFraction){
	if (iNum == 0){
		cerr << "\nError: Number \'" << iNum << "\' was divided by zero.\n";
		if (Fraction::bIgnoreDivideZeroErrors)
			return Fraction();
		else
			throw _FRACTION_ZERO_DIVIDE;
	}
...
bool Fraction::operator>(long long iNum){
	return *this > Fraction(iNum);
}
...
bool Fraction::operator>(double dNum){
	return this->ToDouble() > dNum;
}
...
bool operator>(long long iNum, Fraction fracFraction){
	return Fraction(iNum)>fracFraction;
}
...
bool operator>(double dNum, Fraction fracFraction){
	return dNum>fracFraction.ToDouble();
}
