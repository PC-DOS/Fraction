...
int main(){
	...
	cout << "F1!=F2=" << (frac1 != frac2) << endl;
	cout << endl;
	cout << "F1.Reduction=" << Fraction::Reduction(frac1) << endl;
	cout << "F1.Numden=" << (frac1.Numden(frac2)) << endl;
	cout << "F1.IsInteger=" << frac1.IsInteger() << endl;
	cout << "F1.ToInt(Not ceiled)=" << frac1.ToInt(false) << endl;
	cout << "F1.ToInt(Ceiled)="<< frac1.ToInt(true) << endl;
	cout << "F1.ToDouble=" << frac1.ToDouble() << endl;
	cout << "F1+=2=" << (frac1 += 2) << endl;
	cout << "F1-=2=" << (frac1 -= 2) << endl;
	cout << "F1*=2=" << (frac1 *= 2) << endl;
	cout << "F1/=2=" << (frac1 /= 2) << endl;
	cout << endl;
	cout << "F2.Reduction=" << Fraction::Reduction(frac2) << endl;
	cout << "F2.Numden=" << (frac2.Numden(frac2)) << endl;
	cout << "F2.IsInteger=" << frac2.IsInteger() << endl;
	cout << "F2.ToInt(Not ceiled)=" << frac2.ToInt(false) << endl;
	cout << "F2.ToInt(Ceiled)=" << frac2.ToInt(true) << endl;
	cout << "F2.ToDouble=" << frac2.ToDouble() << endl;
	cout << "F2+=2=" << (frac2 += 2) << endl;
	cout << "F2-=2=" << (frac2 -= 2) << endl;
	cout << "F2*=2=" << (frac2 *= 2) << endl;
	cout << "F2/=2=" << (frac2 /= 2) << endl;
	system("pause > nul");
